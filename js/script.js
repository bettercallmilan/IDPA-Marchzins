...
const errorText = {
    birthdayRequired: "Bitte geben Sie ein Geburtsdatum ein.",
    birthdayInvalid: "Bitte geben Sie ein gültiges Geburtsdatum ein.",
    birthdayFuture: "Das Geburtsdatum kann nicht in der Zukunft liegen.",
    capitalRequired: "Bitte geben Sie das Sparkapital ein.",
    capitalPositive: "Das Sparkapital muss positiv sein.",
    rateInvalid: "Der Zinssatz muss zwischen 0 und 10% liegen.",
    taxInvalid: "Die Steuer muss zwischen 0 und 100% liegen."
};
